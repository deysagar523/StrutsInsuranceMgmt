...
<html lang="en">
    ...
    <body class="text-center">
        ...
        <main class="form-signin w-100 m-auto">
            <form action="LoginInsuranceOfficer" method="post">
                <img class="mb-4" src="images/admin.jpg" alt="" width="200" height="200">
                <h1 class="h3 mb-3 fw-normal">Please sign in Insurance Officer</h1>
