...
import com.exavalu.services.InsuranceMasterService;
...
public class InsuranceMaster extends ActionSupport implements ApplicationAware, SessionAware, Serializable {
    ...
    public void setSession(Map<String, Object> session) {
     ...
     public String getDataFromAPI() throws ParseException{
        ...
        ArrayList IMdetails=InsuranceMasterService.getDataFromApi();
        
        boolean res = InsuranceMasterService.insertDataInDB(IMdetails);
//        System.out.println("Size of ApiUser List"+apiUsers.size());
//        System.out.println("Result= "+res);
        if(!IMdetails.isEmpty() && res){
            result = "SUCCESS";
